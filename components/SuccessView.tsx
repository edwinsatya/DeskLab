  ...
  return (
    <div className="min-h-screen bg-[#0F0F10] text-white flex items-center justify-center p-4 lg:p-8">
      <motion.div 
        ...
        className="max-w-md w-full bg-zinc-900 border border-teal-500/30 p-8 lg:p-12 rounded-4xl lg:rounded-[40px] text-center flex flex-col gap-6"
      >
        ...
        <div className="bg-zinc-800/50 p-4 lg:p-5 rounded-2xl text-left">
